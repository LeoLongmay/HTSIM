...
| Eval (vs median CC) | `expA_delaydriven/` (MNSCC arm, figA2dd_signal); `expB_oversub_asym/` (4:1); `expD_scale1024/` (D1, D2) | PRISM floor beats MNSCC median under asymmetry/load (+11–25% at expA; +6–38% at expB 4:1 — but MNSCC is strongest at f4=1, expB 4:1 with cr stable; −2.3% PRISM loss at D2 4:1 f1 single cell, win emerges at f3–f4); generalizes to 1024-node D1 (+6–20%) and D2 4:1 (floor beats at f3–f4); median avoids PRISM's f0 cost. **Honest caveat: one cell loss — at D2 4:1 f1 REPS+MNSCC beats PRISM by 2.3% (974.9 vs 952.7 Gbps); do not claim a blanket win at 4:1 1024-node scale.** |
