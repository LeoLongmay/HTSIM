...
if __name__ == "__main__":
    if "--selftest" in sys.argv:
        ...
        perf_figs.render_main_perf_split(DATA, FIGS, "expD1", BASELINES, FAILED_D1, SEEDS, "figD1", XLABEL_D1, goodput_tbps=True)
        ...
        perf_figs.render_main_perf_split(DATA, FIGS, "expD3load", BASELINES, LOADS, SEEDS,
                                         "figD3_load", XLABEL_LOAD, token="L", goodput_tbps=True)
