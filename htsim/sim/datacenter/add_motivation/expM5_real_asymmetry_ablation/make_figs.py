#!/usr/bin/env python3
"""Render the fixed M5 real-asymmetry ablation from summary CSV only."""
...
def render_figure(summary_path: Path, figures_root: Path) -> Path:
    ...
    stem = figures_root / "m5_real_asymmetry_ablation"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--summary", type=Path, default=HERE / "data" / "aggregate" / "m5_summary.csv")
