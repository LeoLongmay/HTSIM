"""Contract tests for the fixed M7 real-asymmetry runner."""
...
class M7RunnerTests(unittest.TestCase):
    ...
    def test_arm_mapping_and_environment_are_locked(self):
        expected = {
            ...
            "hold_to_increase_prism": ("prism", "reps_actual", "-disable_trim -prism_coordination_mode original_prism -prism_hold_as_increase"),
            "observe_only_prism": ("prism", "reps_actual", "-disable_trim -prism_engage_mult 1000000"),
        }
    ...
    def test_matching_outputs_reuse_and_conflicting_manifest_is_rejected(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            case = run.Case("hold_to_increase_prism", 4, 13)
